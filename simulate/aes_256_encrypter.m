...
%----------Read key--------------------------------------------------------
fdata_key = fopen('aes_256_key.dat', 'r');
...
Key_AES1 = aes_array_to_matrix(Key_AES(1:128));
Key_AES2 = aes_array_to_matrix(Key_AES(129:256));
Key_AES = [Key_AES1 Key_AES2];
fclose(fdata_key);
clear A
...
%-----------Write data-----------------------------------------------------
fdata_out = fopen('aes_256_output_data.dat', 'wb');
fprintf(fdata_out, '%d\n', Input_data_length);
